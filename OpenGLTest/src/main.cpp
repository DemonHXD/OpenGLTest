...
int main() {
	...
	Shader ourShader("E:/openGL/openGL_C++_Pro/OpenGLTest/OpenGLTest/asset/vertexShader.vs",
		"E:/openGL/openGL_C++_Pro/OpenGLTest/OpenGLTest/asset/fragmentShader.fs");
	float vertices[] = {
	...
	unsigned char *data = stbi_load("E:/openGL/openGL_C++_Pro/OpenGLTest/OpenGLTest/asset/container.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	data = stbi_load("E:/openGL/openGL_C++_Pro/OpenGLTest/OpenGLTest/asset/awesomeface.png", &width, &height, &nrChannels, 0);
	if (data)
	{
